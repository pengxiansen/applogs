...
//			URL[] urls = {new URL("http://localhost:8080/logs/startupLogs"),
//					new URL("http://hadoop-senior01.itguigu.com:80/log-analysis04/logs/pageLogs"),
//					new URL("http://hadoop-senior01.itguigu.com:80/log-analysis04/logs/errorLogs")};

			URL[] urls = {new URL("http://hadoop03:80/logs/startupLogs"),
					new URL("http://hadoop03:80/logs/pageLogs"),
					new URL("http://hadoop03:80/logs/errorLogs")};
